...
void extConvert__IntToString_(OBNC_LONGI int i, char s[], OBNC_LONGI int sLen, int *done)
{
	int strLen, n;
...
void extConvert__RealToString_(OBNC_LONGR double x, char s[], OBNC_LONGI int sLen, int *done)
{
...
void extConvert__StringToInt_(const char s[], OBNC_LONGI int sLen, OBNC_LONGI int *i, int *done)
{
...
void extConvert__StringToReal_(const char s[], OBNC_LONGI int sLen, OBNC_LONGR double *x, int *done)
{
	int n;
