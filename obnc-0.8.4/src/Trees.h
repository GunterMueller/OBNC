...
Trees_Node Trees_NewInteger(int value);

int Trees_Integer(Trees_Node integerNode);


/*Real numbers*/

Trees_Node Trees_NewReal(double value);

double Trees_Real(Trees_Node realNode);
...
Trees_Node Trees_NewSet(unsigned int value);

unsigned int Trees_Set(Trees_Node setNode);
