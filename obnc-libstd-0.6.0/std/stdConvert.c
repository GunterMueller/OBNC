...
void stdConvert__IntToString_(OBNC_LONGI int i, char s[], OBNC_LONGI int sLen, int *done)
{
	int strLen, n;
...
void stdConvert__RealToString_(OBNC_LONGR double x, char s[], OBNC_LONGI int sLen, int *done)
{
...
void stdConvert__StringToInt_(const char s[], OBNC_LONGI int sLen, OBNC_LONGI int *i, int *done)
{
...
void stdConvert__StringToReal_(const char s[], OBNC_LONGI int sLen, OBNC_LONGR double *x, int *done)
{
	int n;
